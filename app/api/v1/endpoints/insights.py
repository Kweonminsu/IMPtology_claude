...
#     """
#     return get_insights(
#         db, skip=skip, limit=limit, dataset_id=dataset_id, category=category
#     )
#
#
...
#     if insight is None:
#         raise HTTPException(
#             status_code=status.HTTP_404_NOT_FOUND, detail="인사이트를 찾을 수 없습니다"
#         )
#     return insight
#
#
...
#         ..., description="분석 유형 (correlation, trend, anomaly, prediction)"
#     ),
...
#         db, dataset_id, analysis_type, params, current_user.id
#     )
