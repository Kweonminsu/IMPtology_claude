document.addEventListener("DOMContentLoaded", function () {
  ...
  const tables = [
    {
      ...
      category: "production",
      description:
        "공장에서 생산된 제품의 이력을 저장하는 테이블입니다. 설비별, 라인별, 제품별 생산량 및 불량률 등의 생산 관련 데이터를 포함합니다.",
      updateCycle: "실시간",
      admin: "생산관리팀",
      recordCount: 1287654,
    ...
    },
    {
      ...
      category: "quality",
      description:
        "제품의 품질 검사 결과를 저장하는 테이블입니다. 각종 품질 지표와 검사 결과 데이터를 포함합니다.",
      updateCycle: "일 1회",
      admin: "품질관리팀",
      recordCount: 354982,
    ...
    },
    {
      ...
      category: "sales",
      description:
        "제품 판매 거래 내역을 저장하는 테이블입니다. 고객, 제품, 판매량, 매출액 등의 판매 관련 데이터를 포함합니다.",
      updateCycle: "시간당",
      admin: "영업팀",
      recordCount: 892561,
    ...
    },
    {
      ...
      category: "production",
      description:
        "제품 및 원자재의 재고 현황을 저장하는 테이블입니다. 현재 재고량, 입고량, 출고량 등의 재고 관련 데이터를 포함합니다.",
      updateCycle: "일 1회",
      admin: "자재관리팀",
      recordCount: 42680,
      createdDate: "2023-04-15",
    ...
    },
    {
      ...
      category: "hr",
      description:
        "회사 직원들의 기본 정보를 저장하는 테이블입니다. 직원 연락처, 부서, 직급 등의 인사 관련 데이터를 포함합니다.",
      updateCycle: "주 1회",
      admin: "인사팀",
      recordCount: 3256,
    ...
    },
    {
      ...
      category: "sales",
      description:
        "고객 정보를 저장하는 테이블입니다. 고객 연락처, 주소, 구매 이력 등의 고객 관련 데이터를 포함합니다.",
      updateCycle: "일 1회",
      admin: "마케팅팀",
      recordCount: 125789,
  ...
  function openTableDetail(tableId) {
    ...
    document.getElementById(
      "last-update"
    ).textContent = `마지막 업데이트: ${table.lastUpdate}`;
  ...
  document
    .getElementById("table-search")
    .addEventListener("input", searchTables);
  document
    .getElementById("category-filter")
    .addEventListener("change", searchTables);
  ...
  // 정보 다운로드 버튼 클릭 이벤트
  document
    .querySelector(".download-info-btn")
    .addEventListener("click", function () {
